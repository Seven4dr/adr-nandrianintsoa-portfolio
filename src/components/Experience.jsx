...
const Experiences = () => {
  ...
  const experiences = [
    {
      icon: (
        <BookOpen className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-purple-400" />
      ),
    ...
    {
      icon: (
        <UserPlus className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-purple-400" />
      ),
    ...
    {
      icon: (
        <Car className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-purple-400" />
      ),
    ...
    {
      icon: (
        <Server className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-green-400" />
      ),
    ...
    {
      icon: (
        <Smartphone className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-purple-400" />
      ),
    ...
    },
    {
      ...
      features: [
        "ChatBot pour tester les symptômes",
        "Modélisation 3D",
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto">
        ...
        <div ref={titleRef} className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-sm sm:text-base lg:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed px-4">
            Découvrez mon parcours professionnel et académique à travers mes
        ...
        <div
          ref={timelineRef}
          className="relative max-w-6xl mx-auto mb-8 sm:mb-12 lg:mb-16"
        >
          ...
          <div className="space-y-4 sm:space-y-6 lg:space-y-8">
            {experiences.map((exp, index) => (
              <div
                key={index}
                className={`timeline-item timeline-item-${index} relative`}
              >
                  ...
                  <div
                    className={`group relative bg-gray-800/60 backdrop-blur-sm border border-gray-700/50 rounded-xl sm:rounded-2xl p-4 sm:p-5 lg:p-6 hover:border-purple-500/50 transition-all duration-500 hover:shadow-xl hover:shadow-purple-500/10 hover:-translate-y-1 cursor-pointer ${
                      activeExperience === index
                        ? "ring-1 sm:ring-2 ring-purple-400 border-purple-400/50"
                        : ""
                    }`}
                    ...
                    <div className="relative z-10">
                      ...
                      {exp.companyLogo && (
                        <div className="mb-3 sm:mb-4">
                          <img
                            src={
                              exp.companyLogo.placeholder || "/placeholder.svg"
                            }
        ...
        <div
          ref={statsRef}
          className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 max-w-6xl mx-auto"
        >
          ...
          <div className="group relative bg-gray-800/60 backdrop-blur-sm border border-gray-700/50 rounded-xl sm:rounded-2xl p-3 sm:p-4 lg:p-6 hover:border-blue-500/50 transition-all duration-300 hover:-translate-y-1">
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
              ...
              <div className="text-center sm:text-left">
                <div className="text-xl sm:text-2xl lg:text-3xl font-black text-white">
                  {
                    experiences.filter((exp) => exp.category === "internship")
                      .length
                  }
                </div>
          ...
          <div className="group relative bg-gray-800/60 backdrop-blur-sm border border-gray-700/50 rounded-xl sm:rounded-2xl p-3 sm:p-4 lg:p-6 hover:border-yellow-500/50 transition-all duration-300 hover:-translate-y-1">
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
              ...
              <div className="text-center sm:text-left">
                <div className="text-xl sm:text-2xl lg:text-3xl font-black text-white">
                  {
                    experiences.filter((exp) => exp.category === "competition")
                      .length
                  }
                </div>
