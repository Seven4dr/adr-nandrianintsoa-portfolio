...
const Experiences = () => {
  ...
  return (
    <div className="w-full px-4 py-6 mt-4 text-white overflow-hidden">
      <div className="container mx-auto max-w-6xl">
     <div className="max-w-7xl mx-auto mb-12 px-4">
      <h2 
        className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-4 uppercase tracking-wide"
        data-aos="fade-down"
      >
